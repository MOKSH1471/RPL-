...
('f_food_preference', NULL, 'food_preference', 'Food Preference (Spice Level)', 'select', '["Regular", "Non-Spicy"]', '{"required": true}', 8),
('f_accommodation', NULL, 'accommodation_required', 'Accommodation Required', 'select', '["Yes", "No"]', '{"required": true}', 9),
('f_check_in_date', NULL, 'check_in_date', 'Check-In Date', 'date', NULL, '{"required": false}', 10),
('f_check_out_date', NULL, 'check_out_date', 'Check-Out Date', 'date', NULL, '{"required": false}', 11),
('f_rpl_family', NULL, 'existing_rpl_family', 'Existing RPL Family Member?', 'select', '["Yes", "No"]', '{"required": true}', 12),
('f_photo', NULL, 'photo', 'Profile Photo (Passport / ID)', 'file', NULL, '{"required": false}', 13),
