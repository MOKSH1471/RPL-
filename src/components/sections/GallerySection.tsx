...
export const GallerySection: React.FC = () => {
  ...
  return (
    <section id="gallery" className="py-16 md:py-24 relative z-10 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <InView
          ...
          className="flex flex-nowrap sm:flex-wrap justify-start sm:justify-center items-center gap-2 sm:gap-3 mb-10 md:mb-12 overflow-x-auto mobile-hide-scrollbar px-1 pb-1"
        >
          {[
            ...
            <button
              ...
              className={`flex-shrink-0 px-5 py-2.5 rounded-xl font-bold text-sm transition-all border min-h-[44px] touch-manipulation ${
                activeFilter === tab.id
                  ? 'bg-gradient-to-r from-amber-500 to-amber-600 text-white border-transparent shadow-md scale-105'
          ...
          {filteredItems.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className={`relative overflow-hidden ${isHeroCard ? 'h-56 sm:h-80 md:h-96' : 'h-48 sm:h-64'}`}>
                    <img
                      src={item.image}
                      alt={item.title}
                      loading="lazy"
